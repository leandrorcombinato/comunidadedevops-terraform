...
| <a name="output_oidc"></a> [oidc](#output\_oidc) | OIDC issuer URL completa do cluster EKS |
| <a name="output_oidc_id"></a> [oidc\_id](#output\_oidc\_id) | ID extraído do OIDC issuer (usado para IAM roles) |
